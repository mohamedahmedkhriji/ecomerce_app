...
import 'package:spacemarket_app/users/model/order.dart';
import 'package:spacemarket_app/users/order/order_details.dart';
                  ...
                  child: ListTile(
                    ...
                    title: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Amount: \DT " + eachOrderData.totalAmount.toString(),
                          style: const TextStyle(
                            fontSize: 16,
